...
public class rantier extends Supertier {
		...
		public rantier(int alt,String nam,boolean gesch, double gro, String far, String essen, boolean stub ){
			alter = alt;
			name = nam;
			geschlecht = gesch;
			groesse = gro;
		...
		{
			System.out.println("Dein rantier macht sitz, amk");
		}
